...
<div id="app"></div>
<style>
:root{color-scheme:light;--brand:#1597dc;--brand-dark:#0878b8;--brand-soft:#e9f7ff;--ink:#10202c;--muted:#6f7f8b;--line:#dce7ee;--bg:#f4f7fa;--card:#fff;--success:#13a56d;--danger:#ef476f;--shadow:0 12px 32px rgba(23,79,112,.09)}
*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:var(--bg);color:var(--ink);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;-webkit-tap-highlight-color:transparent}body{overflow-x:hidden}button,input,textarea{font:inherit}.app{width:100%;padding:0 0 calc(92px + env(safe-area-inset-bottom))}.top{position:sticky;top:0;z-index:8;background:rgba(244,247,250,.94);backdrop-filter:blur(18px);padding:10px 12px 8px}.hero{display:flex;align-items:center;justify-content:space-between;gap:12px;background:linear-gradient(135deg,#57c5f1 0%,#1699de 55%,#0878b8 100%);color:#fff;border-radius:24px;padding:16px 18px;box-shadow:var(--shadow)}.brand{display:flex;align-items:center;gap:12px;min-width:0}.brand-icon{width:56px;height:56px;border-radius:18px;background:rgba(255,255,255,.2);display:grid;place-items:center;font-size:30px;flex:0 0 auto}.brand h1{font-size:26px;line-height:1;margin:0 0 5px}.brand p{font-size:14px;line-height:1.25;margin:0;opacity:.92}.count{font-size:13px;font-weight:800;background:rgba(255,255,255,.2);padding:9px 11px;border-radius:999px;white-space:nowrap}.searchbar{margin-top:10px;display:flex;gap:8px}.searchwrap{position:relative;flex:1}.searchwrap input{width:100%;border:1px solid var(--line);background:#fff;color:var(--ink);border-radius:16px;padding:13px 42px 13px 15px;outline:none;font-size:16px}.searchwrap input:focus{border-color:var(--brand);box-shadow:0 0 0 3px rgba(21,151,220,.12)}.searchicon{position:absolute;right:14px;top:12px;color:var(--muted)}.filterbtn{border:0;border-radius:16px;background:var(--brand-soft);color:var(--brand-dark);font-weight:800;padding:0 14px}.content{padding:2px 12px 0}.section{margin-top:16px}.section-head{display:flex;align-items:end;justify-content:space-between;gap:8px;margin:0 2px 10px}.section-head h2{margin:0;font-size:22px;line-height:1.15}.section-head span{font-size:13px;color:var(--muted);white-space:nowrap}.quick-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.quick{border:1px solid var(--line);background:var(--card);border-radius:20px;padding:15px;text-align:left;color:inherit;min-height:105px;box-shadow:0 5px 16px rgba(31,75,100,.05)}.quick .ico{font-size:25px}.quick b{display:block;font-size:18px;margin-top:8px}.quick small{display:block;color:var(--muted);font-size:13px;margin-top:3px}.category-strip{display:flex;gap:8px;overflow-x:auto;padding:2px 0 4px;scrollbar-width:none}.category-strip::-webkit-scrollbar{display:none}.chip{border:0;background:#fff;color:var(--muted);padding:9px 13px;border-radius:999px;font-weight:750;white-space:nowrap;border:1px solid var(--line)}.chip.active{background:var(--brand);color:#fff;border-color:var(--brand)}.list{display:grid;grid-template-columns:1fr;gap:16px}.card{background:#fff;border:1px solid var(--line);border-radius:24px;overflow:hidden;box-shadow:var(--shadow);position:relative}.imagebox{height:min(74vw,520px);min-height:330px;background:#fff;position:relative;display:flex;align-items:center;justify-content:center;padding:12px}.imagebox img{width:100%;height:100%;object-fit:contain;display:block}.heart{position:absolute;right:12px;top:12px;border:0;width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,.95);font-size:23px;box-shadow:0 4px 14px rgba(0,0,0,.08)}.stock{position:absolute;left:12px;bottom:12px;background:rgba(255,255,255,.96);color:var(--success);border-radius:999px;padding:7px 10px;font-size:12px;font-weight:850;box-shadow:0 4px 14px rgba(0,0,0,.06)}.info{padding:16px}.badges{display:flex;gap:7px;flex-wrap:wrap;margin-bottom:9px}.tag{display:inline-flex;align-items:center;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:850;background:var(--brand-soft);color:var(--brand-dark)}.tag.hot{background:#fff0e8;color:#c95a16}.title{font-size:20px;line-height:1.28;font-weight:760;margin:0 0 7px;overflow-wrap:anywhere}.meta{font-size:13px;color:var(--muted);margin-bottom:9px}.price{font-size:30px;font-weight:900;letter-spacing:-.5px}.actions{display:grid;grid-template-columns:52px 1fr;gap:9px;margin-top:13px}.details,.add{border:0;border-radius:15px;font-weight:850;min-height:50px}.details{background:var(--brand-soft);color:var(--brand-dark);font-size:20px}.add{background:linear-gradient(135deg,var(--brand),var(--brand-dark));color:#fff;font-size:16px}.empty{background:#fff;border:1px solid var(--line);border-radius:20px;text-align:center;padding:42px 14px;color:var(--muted)}.bottom{position:fixed;left:0;right:0;bottom:0;z-index:12;background:rgba(244,247,250,.94);backdrop-filter:blur(18px);border-top:1px solid var(--line);padding:8px 8px calc(8px + env(safe-area-inset-bottom))}.bottom-inner{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:5px;width:100%;max-width:900px;margin:auto}.nav{border:0;border-radius:15px;background:#fff;color:var(--ink);font-size:11px;font-weight:780;padding:8px 2px}.nav.active{background:var(--brand);color:#fff}.nav i{font-style:normal;display:block;font-size:21px;margin-bottom:3px}.badge{display:inline-grid;place-items:center;min-width:18px;height:18px;padding:0 4px;border-radius:99px;background:#fff;color:var(--brand);font-size:10px;margin-left:2px}.modal{position:fixed;inset:0;background:rgba(0,0,0,.46);display:flex;align-items:flex-end;z-index:30}.sheet{width:100%;max-height:96vh;overflow:auto;background:var(--bg);border-radius:28px 28px 0 0;padding:10px 14px calc(22px + env(safe-area-inset-bottom))}.grab{width:48px;height:5px;border-radius:99px;background:#c8d3da;margin:2px auto 10px}.close{float:right;border:0;background:#fff;width:40px;height:40px;border-radius:50%;font-size:24px}.sheet-image{width:100%;height:min(72vw,520px);object-fit:contain;background:#fff;border-radius:22px}.sheet h2{font-size:24px;line-height:1.22;margin:14px 0 7px}.sheet-price{font-size:31px;font-weight:900}.description{color:var(--muted);line-height:1.55;white-space:pre-line}.sheet-actions{display:grid;grid-template-columns:56px 1fr;gap:10px;margin-top:15px}.primary{border:0;border-radius:15px;background:linear-gradient(135deg,var(--brand),var(--brand-dark));color:#fff;font-weight:850;padding:14px}.secondary{border:0;border-radius:15px;background:#fff;font-size:23px}.cat-list{display:grid;gap:8px;margin-top:12px}.cat-item{border:1px solid var(--line);background:#fff;color:inherit;border-radius:15px;padding:13px 14px;display:flex;justify-content:space-between;font-weight:750}.cat-item.active{border-color:var(--brand);background:var(--brand-soft);color:var(--brand-dark)}.cart-item{display:grid;grid-template-columns:68px 1fr auto;gap:10px;align-items:center;background:#fff;border:1px solid var(--line);border-radius:16px;padding:9px;margin:9px 0}.cart-item img{width:68px;height:68px;object-fit:contain;border-radius:12px}.cart-title{font-size:14px;line-height:1.3}.qty{display:flex;align-items:center;gap:7px}.qty button{border:0;background:var(--brand-soft);color:var(--brand-dark);width:31px;height:31px;border-radius:10px;font-weight:850}.summary{display:flex;justify-content:space-between;font-size:22px;font-weight:900;margin:17px 2px}.checkout{display:grid;gap:8px}.checkout input,.checkout textarea{width:100%;border:1px solid var(--line);background:#fff;border-radius:13px;padding:12px;color:inherit}.loader{text-align:center;padding:60px 14px;color:var(--muted)}.toast{position:fixed;left:50%;bottom:102px;transform:translateX(-50%);background:#10202c;color:#fff;padding:10px 14px;border-radius:999px;z-index:60;font-weight:700;font-size:13px}.muted{color:var(--muted)}
@media(min-width:760px){.top,.content{padding-left:20px;padding-right:20px}.quick-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.list{grid-template-columns:repeat(2,minmax(0,1fr))}.imagebox{height:390px}.sheet{max-width:720px;margin:0 auto}.bottom-inner{max-width:720px}}
</style>
...
function isCandy(p){const c=(p.category||'').toLowerCase(),t=(p.title||'').toLowerCase();return c.includes('цук')||c.includes('подарун')||t.includes('цукерк')||t.includes('подарунков')}
...
function card(p){return `<article class="card" data-card="${p.id}"><div class="imagebox"><img src="${esc(p.image||'')}" alt="${esc(p.title)}"><button class="heart" data-fav="${p.id}">${state.favorites.has(p.id)?'❤️':'🤍'}</button><span class="stock">● В наявності</span></div><div class="info"><div class="badges"><span class="tag hot">🔥 Вигідно</span><span class="tag">OKVEJ</span></div><h3 class="title">${esc(p.title)}</h3><div class="meta">${esc(p.category||'Товар')}</div><div class="price">${money(p.price)}</div><div class="actions"><button class="details" data-details="${p.id}">ℹ️</button><button class="add" data-add="${p.id}">🛒 У кошик</button></div></div></article>`}
...
function shell(main){return `<main class="app"><header class="top"><div class="hero"><div class="brand"><div class="brand-icon">🍬</div><div><h1>OKVEJ</h1><p>Солодощі з доставкою по Україні</p></div></div><div class="count">${state.products.length} товарів</div></div><div class="searchbar"><div class="searchwrap"><input id="search" value="${esc(state.query)}" placeholder="Пошук товару"><span class="searchicon">🔍</span></div><button class="filterbtn" id="filters">📂</button></div></header><div class="content">${main}</div>${nav()}</main>`}
function home(){const c=cats();const top=Object.keys(c).sort((a,b)=>c[b]-c[a]).slice(0,4);const premium=state.products.filter(isCandy).sort((a,b)=>b.price-a.price).slice(0,6);return `<section class="section"><div class="quick-grid"><button class="quick" data-home="catalog"><span class="ico">📂</span><b>Каталог</b><small>Усі товари</small></button><button class="quick" data-home="favorites"><span class="ico">❤️</span><b>Обране</b><small>${state.favorites.size} товарів</small></button><button class="quick" data-home="recent"><span class="ico">🕓</span><b>Переглянуті</b><small>${state.recent.length} товарів</small></button><button class="quick" data-home="cart"><span class="ico">🛒</span><b>Кошик</b><small>${countCart()} товарів</small></button></div></section><section class="section"><div class="section-head"><h2>Популярні категорії</h2></div><div class="quick-grid">${top.map(x=>`<button class="quick" data-cat="${esc(x)}"><span class="ico">🍬</span><b>${esc(x)}</b><small>${c[x]} товарів</small></button>`).join('')}</div></section><section class="section"><div class="section-head"><h2>💎 Цукерки та подарункові набори</h2><span>преміум</span></div><div class="list">${premium.map(card).join('')||'<div class="empty">Товари не знайдено</div>'}</div></section>`}
function catalog(){const list=filtered();const c=cats();const top=['Усі',...Object.keys(c).sort((a,b)=>c[b]-c[a]).slice(0,8)];return `<section class="section"><div class="category-strip">${top.map(x=>`<button class="chip ${state.category===x?'active':''}" data-chip="${esc(x)}">${esc(x)}</button>`).join('')}</div></section><section class="section"><div class="section-head"><h2>${state.mode==='favorites'?'Обране':state.category==='Усі'?'Каталог':esc(state.category)}</h2><span>${list.length} товарів</span></div><div class="list">${list.map(card).join('')||'<div class="empty">Нічого не знайдено</div>'}</div></section>`}
function render(){app.innerHTML=shell(state.mode==='home'?home():catalog());bind()}
function bind(){document.querySelectorAll('[data-nav]').forEach(b=>b.onclick=()=>{const m=b.dataset.nav;if(m==='cart')return openCart();if(m==='search'){state.mode='catalog';render();setTimeout(()=>document.querySelector('#search')?.focus(),60);return}state.mode=m;state.category='Усі';render()});document.querySelectorAll('[data-home]').forEach(b=>b.onclick=()=>{const m=b.dataset.home;if(m==='cart')openCart();else if(m==='recent')openRecent();else{state.mode=m;render()}});document.querySelectorAll('[data-cat]').forEach(b=>b.onclick=()=>{state.category=b.dataset.cat;state.mode='catalog';render()});document.querySelectorAll('[data-chip]').forEach(b=>b.onclick=()=>{state.category=b.dataset.chip;render()});document.querySelectorAll('[data-card]').forEach(el=>el.onclick=e=>{if(e.target.closest('button'))return;details(el.dataset.card)});document.querySelectorAll('[data-details]').forEach(b=>b.onclick=()=>details(b.dataset.details));document.querySelectorAll('[data-add]').forEach(b=>b.onclick=()=>add(b.dataset.add));document.querySelectorAll('[data-fav]').forEach(b=>b.onclick=()=>toggleFav(b.dataset.fav));document.querySelector('#filters')?.addEventListener('click',openCategories);let timer;document.querySelector('#search')?.addEventListener('input',e=>{state.query=e.target.value.toLowerCase();clearTimeout(timer);timer=setTimeout(()=>{const caret=e.target.selectionStart||state.query.length;render();requestAnimationFrame(()=>{const i=document.querySelector('#search');if(i){i.focus();i.setSelectionRange(caret,caret)}})},280)})}
